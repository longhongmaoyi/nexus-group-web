  ...
  return (
    <main className="min-h-screen bg-[#f4f1e9] text-[#11191b]">
      ...
      <section className="mx-auto max-w-[1320px] px-5 py-14 sm:px-8 lg:px-12 lg:py-20">
        <div className="border-l-4 border-[#176b96] bg-white p-6 shadow-soft sm:p-8">
          <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#176b96]">{text(page.calloutTitle)}</p>
